...
func (TopLevelDesc) Help() *markers.DefinitionHelp {
	return &markers.DefinitionHelp{
		Category: "CRD",
		DetailedHelp: markers.DetailedHelp{
			Summary: "adds \"description\" to the top-level validation schema. ",
			Details: "This is useful for CRDs that want a top-level description field to describe the resource. Specifying this marker will add a description field at the top-level to the validation schema.",
		},
		FieldHelp: map[string]markers.DetailedHelp{},
	}
}
...
func (XValidation) Help() *markers.DefinitionHelp {
	return &markers.DefinitionHelp{
		...
		FieldHelp: map[string]markers.DetailedHelp{
			"Rule": markers.DetailedHelp{
				Summary: "",
				Details: "",
			},
			"Message": markers.DetailedHelp{
				Summary: "",
				Details: "",
			},
		},
